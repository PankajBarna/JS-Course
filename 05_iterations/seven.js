...
// const filterBooks = books.map((book) => (book.title))
//function chaining-----use of filter and map function combined--------------------------------------
const filterBooks = books.filter((book) => (book.genre === "Self-Help")).map((book) => book.title)
console.log(filterBooks)            // o/p: [ 'Atomic Habits', 'Ikigai' ]